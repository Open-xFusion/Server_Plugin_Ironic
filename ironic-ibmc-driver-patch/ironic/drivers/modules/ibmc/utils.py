...
from ironic.drivers.modules.ibmc import exception as ibmc_ex
...
def handle_ibmc_exception(action):
    ...
    def decorator(f):
        ...
        def should_retry(e):
            connect_error = isinstance(e, ibmc_ex.IBMCConnectionError)
            if connect_error:
